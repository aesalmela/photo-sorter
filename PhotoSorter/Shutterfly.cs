...
namespace PicImp
{
    class Shutterfly
    {
        private static string shutterflyHost = "https://ws.shutterfly.com";
        private static string shutterflyUpHost = "http://up3.shutterfly.com";
        ...
        public static string uploadToShutterfly(string authenticationID, string oflyAppID, string month, string year, string filePath, string fileName)
        {
            string uploadURL = shutterflyUpHost + "/images?oflyAppId=" + oflyAppID;

            return shutterflyUpload(uploadURL, authenticationID, month, year, filePath + @"\" + fileName, fileName);
        }

        private static string shutterflyUpload(string uploadURL, string authenticationID, string month, string year, string filePath, string fileName)
        {
            // Read file data
            ...
            postParameters.Add("AuthenticationID", authenticationID);
            postParameters.Add("Image.AlbumName", month);
            postParameters.Add("Image.FolderName", year);
            postParameters.Add("Image.Data", new Shutterfly.FileParameter(data, fileName, "image/jpeg"));
